<?php
class Tomato_Db_Mysql extends Zend_Db_Adapter_Abstract
{
	/**
	 ...
	 * @var string
	 */
	protected $_defaultStmtClass = 'Tomato_Db_Statement_Mysql';

	/**
	 * Gibt unsere Select_Mysql-Instanz zurück, damit wir SqlCalcFoundRows() verwenden können
	...
	protected function _connect()
	{
		...
		$persistent = isset($this->_config['persistent']) && ($this->_config['persistent'] == 'true');
